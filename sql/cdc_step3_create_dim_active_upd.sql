...
FROM (cos://us-south/<transform-bucket-name>/DIM_ACTIVE.CSV STORED AS CSV) AS t1
LEFT JOIN (cos://us-south/<transform-bucket-name>/DIM_ACTIVE_SOURCE STORED AS CSV) AS t2
ON t1.ID_RSSD = t2.ID_RSSD

INTO cos://us-south/<transform-bucket-name>/DIM_ACTIVE_UPD JOBPREFIX NONE STORED AS CSV
